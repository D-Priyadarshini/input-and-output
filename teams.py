...
team1Name = input()
team1Scorce = int(input())
team1oversPlayed = int(input())
team2Name = input()
team2Scorce = int(input())
team2oversPlayed = int(input())
print("Match Details:")
print("Team 1:")
print("Team Name:",team1Name )
print("Score:",team1Scorce)
print("Overs played:",team1oversPlayed )
print("Team 2:")
print("Team Name:",team2Name )
print("Score:",team2Scorce)
print("Overs played:",team2oversPlayed )
